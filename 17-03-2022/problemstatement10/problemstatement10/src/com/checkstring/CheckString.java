...
public class CheckString 
{
	...
	public static void main(String[] args)
	{
		...
		if (isInterleaving(X, Y, Z)) {
			System.out.print("third string is valid shuffle of first and second string");
		}
		else {
			System.out.print(" third string is NOT a valid shuffle of first and second string");
		}
	}
